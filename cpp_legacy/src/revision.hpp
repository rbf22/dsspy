...
constexpr const char kProjectName[] = "mkdssp";
constexpr const char kVersionNumber[] = "4.5.5";
...
const class version_info_impl : public version_info_v1_1::version_info<version_info_impl>
{
  public:
	version_info_impl()
