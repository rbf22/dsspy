...
constexpr const char klibdsspVersionNumber[] = "4.5.5";
constexpr int klibdsspBuildNumber = 0;
constexpr const char klibdsspRevisionGitTag[] = "";
constexpr const char klibdsspRevisionDate[] = "";
